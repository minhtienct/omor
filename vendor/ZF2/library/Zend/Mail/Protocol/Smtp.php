...
class Smtp extends AbstractProtocol
{
    ...
    public function helo($host = '127.0.0.1')
    {
        ...
        if ($this->secure == 'tls') {
            ...
            // Warning: stream_socket_enable_crypto(): SSL operation failed with code 1. OpenSSL Error messages: error:14090086:SSL routines:ssl3_get_server_certificate:certificate verify failed in /var/www/Omolink/vendor/ZF2/library/Zend/Mail/Protocol/Smtp.php on line 182
            stream_context_set_option($this->socket, 'ssl', 'verify_host', false);
